...
Foc_CpG$Gene<-Foc_CpG$ID#sapply(strsplit(as.character(Foc_CpG$ID),'-'), `[`, 2)
```
...
- New section after reviewers comments

- Select only genes belonging to OrthoGroups
...
Abb_level_Tbl <- AmeGbiLko_CpGeo_OG %>% 
  mutate(Abb_level=paste0(Abb,"_", CpGoe_level)) %>% 
  dplyr::select(Abb_level,OG ) 



Abb_level_Tbl_presentabsense<-fuzzySim::splist2presabs(Abb_level_Tbl, sites.col="Abb_level", sp.col="OG")
rownames(Abb_level_Tbl_presentabsense)<-Abb_level_Tbl_presentabsense[,1]
Abb_level_Tbl_presentabsense<-Abb_level_Tbl_presentabsense[,-1]


## Matches with UpsetPlot, 27 interaction common
length(colSums(Abb_level_Tbl_presentabsense)[colSums(Abb_level_Tbl_presentabsense)==8])

length(colSums(Abb_level_Tbl_presentabsense)[colSums(Abb_level_Tbl_presentabsense)==1])

#colSums(Abb_level_Tbl_presentabsense)[colSums(Abb_level_Tbl_presentabsense)==1]
...
#### CpGoe Level Change: Crickets+Foc low vs Ame High 
...
CricketLow_AmeHigh<-Reduce(intersect, list(AmeGbiLko_CpGeo_OG[AmeGbiLko_CpGeo_OG$CpGoe_level=="Low" & AmeGbiLko_CpGeo_OG$Abb=="Gbi", "OG" ], 
                                         ...
                                         AmeGbiLko_CpGeo_OG[AmeGbiLko_CpGeo_OG$CpGoe_level=="Low" & AmeGbiLko_CpGeo_OG$Abb=="Foc", "OG" ],
...
Fochighlow<-Reduce(intersect, list(AmeGbiLko_CpGeo_OG[AmeGbiLko_CpGeo_OG$CpGoe_level=="Low" & AmeGbiLko_CpGeo_OG$Abb=="Foc", "OG" ], 
                               AmeGbiLko_CpGeo_OG[AmeGbiLko_CpGeo_OG$CpGoe_level=="High" & AmeGbiLko_CpGeo_OG$Abb=="Foc", "OG" ] ))


Amehighlow<-Reduce(intersect, list(AmeGbiLko_CpGeo_OG[AmeGbiLko_CpGeo_OG$CpGoe_level=="Low" & AmeGbiLko_CpGeo_OG$Abb=="Ame", "OG" ], 
                               AmeGbiLko_CpGeo_OG[AmeGbiLko_CpGeo_OG$CpGoe_level=="High" & AmeGbiLko_CpGeo_OG$Abb=="Ame", "OG" ] ))

CricketLow_AmeHigh_2<-CricketLow_AmeHigh[!CricketLow_AmeHigh %in% c(Gbihighlow, Lkohighlow, Amehighlow,Fochighlow) ]
...
dim(CricketLow_AmeHigh_Gbigenes)## the 
...
Crick_Low_Ame_High_weight0_fisher_BP=GenTable(Crick_Low_Ame_High_GOdataBP, weightFisher=Crick_Low_Ame_High_weight01_fisher_BP, orderBy='weightFisher', topNodes=length(allGO), numChar=1000)

Crick_Low_Ame_High_weight0_fisher_BP$pvalue<-topGO::score(Crick_Low_Ame_High_weight01_fisher_BP)[Crick_Low_Ame_High_weight0_fisher_BP$GO.ID]
...
### GO terms based on AME genes

Amesubtable<-AmeGbiLko_CpGeo_OG[AmeGbiLko_CpGeo_OG$Abb=="Ame",]
CricketLow_AmeHigh_Amegenes<-Amesubtable[Amesubtable$OG %in% CricketLow_AmeHigh_2, ]
dim(CricketLow_AmeHigh_Amegenes)## the 
table(CricketLow_AmeHigh_Amegenes$CpGoe_level)


CricketLow_AmeHigh_Gbigenes_Ameedit<-CricketLow_AmeHigh_Amegenes %>% separate(col=Gene, "-",into=c("rna","LOC"))

## selected genes/universe
geneListCrickLow_AmeHigh=factor(as.integer(Ame_CpG$Gene %in%  CricketLow_AmeHigh_Gbigenes_Ameedit$LOC))  ## being or not in the selected ones as Factor
names(geneListCrickLow_AmeHigh)=Ame_CpG$Gene
table(geneListCrickLow_AmeHigh)
                  
Crick_Low_Ame_High_GOdataBP_AMEGOS <- new("topGOdata",
                    description = "Crick Low and Ame High CpGoe (based on Gbi Functons)", ontology = "BP",
                    allGenes =geneListCrickLow_AmeHigh, 
                    #geneSel = Ame_CpG$Gene,
                    nodeSize = 10,
...
Crick_Low_Ame_High_GOdataBP_AMEGOS
```
